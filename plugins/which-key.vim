...
let g:which_key_map['F'] = [':Limelight!!', 'toggle focus mode']
let g:which_key_map['i'] = [':set ignorecase!', 'toggle case sensitive']
let g:which_key_map['n'] = [':set rnu!', 'toggle numbers']
let g:which_key_map['p'] = ['"+p', 'paste from clipboard']
let g:which_key_map['S'] = [':SSave', 'save session']
let g:which_key_map['T'] = [':terminal ++close', 'open terminal']
